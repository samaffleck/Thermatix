...
REM ---------------------------
REM 2. Clean up / create build_wasm
REM ---------------------------
if exist build_wasm (
    rd /s /q build_wasm
)
...
REM ---------------------------
REM 3. Activate Emscripten environment (if needed)
REM    Adjust these calls to match your Emscripten setup.
REM ---------------------------
REM Example, if you have Emscripten in C:\emsdk:
